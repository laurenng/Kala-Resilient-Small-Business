        ...
        return(
            <div id="signupPage">
                ...
                <form onSubmit={this.handleSignup} id="signupForm">
                    ...
                    <div>
                        <h2 className="questionInstructions">Email</h2>
                        <input type="text" value={this.state.user} 
                            onChange={this.userChange} 
                            title="Please enter a valid email address. e.g. johnsmith@example.com" 
                            required></input>
                    </div>

                    <div>
                        <h2 className="questionInstructions">Password</h2>
